...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChineseEntry.ch'
        db.alter_column(u'cedictionary_chineseentry', 'ch', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChineseEntry.pinyin'
        db.alter_column(u'cedictionary_chineseentry', 'pinyin', self.gf('django.db.models.fields.CharField')(max_length=160))

        # Changing field 'ChineseEntry.chs'
        db.alter_column(u'cedictionary_chineseentry', 'chs', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ChineseEntryEnglish.definition'
        db.alter_column(u'cedictionary_chineseentryenglish', 'definition', self.gf('django.db.models.fields.CharField')(max_length=600))

    def backwards(self, orm):

        # Changing field 'ChineseEntry.ch'
        db.alter_column(u'cedictionary_chineseentry', 'ch', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'ChineseEntry.pinyin'
        db.alter_column(u'cedictionary_chineseentry', 'pinyin', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'ChineseEntry.chs'
        db.alter_column(u'cedictionary_chineseentry', 'chs', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'ChineseEntryEnglish.definition'
        db.alter_column(u'cedictionary_chineseentryenglish', 'definition', self.gf('django.db.models.fields.CharField')(max_length=200))
